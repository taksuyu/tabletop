...
-- https://github.com/Soostone/katip/blob/27-monadlogger-compat/katip-monad-logger-compat/src/Katip/Instances/MonadLogger.hs
-- and is subject to it's BSD-3 license!
